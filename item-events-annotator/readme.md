...
This is a docker image wrapping a UIMA pipeline annotating sentences, item and events.
...
The items are annotated using a dictionary which defaults to a list of liver disease which is a subset of the NCIT ontology.
