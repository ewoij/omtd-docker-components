...
version = '1.0.0'
docker_repository = 'ewoij/leica-annotator'
docker_tag = version
...
run_input_dir = '/data/_test_corpus/leica-test'
run_output_dir = '/data/omtd-docker-components/leica-model-annotator/corpus_output'
